...
subset1.to_csv (r'dataset/airports_refined.csv', index=None)

## for airport discriptive data --> Name, City, Country (for user-interface purposes)
subset2 = dataframe[['Name', 'City', 'Country']]
subset2.to_csv (r'dataset/airports_descriptive.csv', index=None)
...
subset3.to_csv (r'dataset/routes_refined.csv', index=None)
